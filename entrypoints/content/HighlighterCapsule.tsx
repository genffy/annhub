...
export default function HighlighterCapsule({ captureCount, onExit }: HighlighterCapsuleProps) {
    ...
    >
      ...
      <span
        style={{
          ...
          boxShadow: showPulse ? '0 0 8px 2px rgba(76,175,80,0.6)' : '0 0 4px 1px rgba(76,175,80,0.3)',
