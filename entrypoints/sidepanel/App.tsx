...
function App() {
  ...
  const renderContent = () => {
    switch (currentView) {
      case 'highlights':
        return <HighlightList className="sidebar-highlight-list" showHeader={false} showPagination={true} initialPageSize={10} />
      case 'chats':
        return (
    ...
    <div className="sidebar-container">
      <div className="sidebar-header">
        ...
        <div className="view-selector">
          <select value={currentView} onChange={e => setCurrentView(e.target.value as ViewMode)} className="view-select">
