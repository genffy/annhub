    ...
    <main className="min-h-screen overflow-x-hidden bg-[#F2F3F5] text-[#1E2B3A]">
      <section className="relative overflow-hidden px-4 pb-16 pt-10 md:px-20 md:pb-24">
        ...
        <nav className="relative z-10 flex items-center justify-between">
          ...
          <Link href="/" className="rounded-full bg-[#673AB8] px-5 py-2 text-sm font-bold text-white shadow-sm transition hover:bg-[#56309b]">
            Home
          </Link>
        </nav>
        <div className="relative z-10 mx-auto mt-20 max-w-6xl">
          ...
          <h1 className="max-w-5xl text-[14vw] font-extrabold leading-[0.9] text-[#1E2B3A] md:text-[108px]">AnnHub in motion.</h1>
